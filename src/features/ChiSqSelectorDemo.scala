...
object ChiSqSelectorDemo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = Seq(
      (0, Vectors.dense(0.5, 10.0, 10.0),0.0),
      (1, Vectors.dense(0.6, 20.0, 20.0),0.0),
      (2, Vectors.dense(1.5, 30.0, 30.0),1.0),
      (3, Vectors.dense(0.4, 30.0, 30.0),0.0),
      (4, Vectors.dense(0.45, 40.5, 40.0),0.0),
      (5, Vectors.dense(1.6, 40.0, 40.0),1.0)
